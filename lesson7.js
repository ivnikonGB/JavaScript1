...
function move() {
    ...
    if (!isSnakeUnit(new_unit) && !isObstacleUnit(new_unit)) {
 ...
 * @returns {boolean}
 */
function isObstacleUnit(unit) {//проверка, что змейка не попала сама в себя в новой ячейке
    var check = false;
...
function haveFood(unit) {
    var check = false;
    var scoreSpan = document.querySelector(".score-value");
